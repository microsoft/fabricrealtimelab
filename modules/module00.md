...
8. On the Azure Event Hubs configuration page, add a new connection and using the values from event hub you noted earlier, specifying the $Default consumer group: 

![Configure Event Hub](../images/module00/eventstream-hubconnection.png)

## :tada: Summary

With the notebook or container generating data and ingesting into our Eventstream, we're ready to start processing the data!

## :white_check_mark: Results

- [x] Configured Fabric environment
- [x] Set up stock generator (notebook or ACI)
